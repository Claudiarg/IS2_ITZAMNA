            ...
            <div id="main-container" class="container-fluid" role="main">
                ...
                <div id="content" > 
                    ...
                    <div id="main-content">	
                        ...
                        <form class="form-horizontal" action="./validacion/AgregarElementoCV.jsp" method="post">
                            <div class="form-group">
                                <select class="form-control input-sm" name="tabla" style='margin-left: 309px; width: 180px; height: 35px'>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <button style="margin-left: 156px" type="submit" class="btn btn-default">Guardar</button>
                                </div>
                            </div>
                        </form>
