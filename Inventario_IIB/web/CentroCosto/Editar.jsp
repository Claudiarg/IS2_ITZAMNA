<%-- 
    Document   : Editar CentroCosto
    Created on : 2/11/2014, 02:37:23 PM
    Author     : beth
--%>
                        ...
                        <form class="form-horizontal" action="Insertar.jsp" method="post" role="form">
                            <div class="form-group">                                                                
                                ...
                                <%
                                    ...
                                    //con.insertarBD("INSERT INTO CentroDeCosto ('idCentroDeCosto', 'Descripcion') VALUES (" + ultimo + 1 + ",'prueba')");
