<%-- 
    Document   : Insertar
    Created on : 2/11/2014, 04:27:12 PM
    Author     : beth
--%>
...
<%@page import="java.sql.*" %>
<%@page import="Controlador.CentroCosto"%>
        ...
        <div id="main">
            ...
            <div id="main-container" class="container-fluid" role="main">
                ...
                <div id="main-title" class="page-header">
                    <h1 style="font-size: 25px">Centro De Costo Creado</h1>
                </div>
                    ...
                    <div id="main-content">	
                            ...
                            <div class="form-group">                                                                
                                <%
                                    ...
                                    con.conectarBD();
                                    int ultimo = 0;
                                    ResultSet r = con.consultarBD("SELECT MAX(idCentroDeCosto) FROM CentroDeCosto;");
                                    while (r.next()) {
                                        ultimo = r.getInt(1);
                                    ...
                                    String p="INSERT INTO CentroDeCosto (idCentroDeCosto, Descripcion) VALUES (" + (ultimo + 1) + ",'"+nuevo+"');";
                                    con.insertarBD(p);
