        ...
        <div id="main">
            ...
            <div id="main-container" class="container-fluid" role="main">
                ...
                <div id="main-title" class="page-header">
                    <h1 style="font-size: 25px">Nivel de Obsolescencia Creado</h1>
                </div>
                    ...
                    <div id="main-content">	
                            ...
                            <div class="form-group">                                                                
                                <%
                                    ...
                                    con.conectarBD();
                                    int ultimo = 0;
                                    ResultSet r = con.consultarBD("SELECT MAX(idNivelObsolescencia) FROM NivelObsolescencia;");
                                    while (r.next()) {
                                        ultimo = r.getInt(1);
                                    ...
                                    String p="INSERT INTO NivelObsolescencia (idNivelObsolescencia, Descripcion) VALUES (" + (ultimo + 1) + ",'"+nuevo+"');";
                                    con.insertarBD(p);
