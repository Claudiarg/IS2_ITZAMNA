...
<%@page import="java.sql.*" %>
<%@page import="Controlador.Ubicacion"%>
        ...
        <div id="main">
            ...
            <div id="main-container" class="container-fluid" role="main">
                ...
                <div id="main-title" class="page-header">
                    <h1 style="font-size: 25px">Ubicacion Creada</h1>
                </div>
                    ...
                    <div id="main-content">	
                            ...
                            <div class="form-group">                                                                
                                <%
                                    ...
                                    con.conectarBD();
                                    int ultimo = 0;
                                    ResultSet r = con.consultarBD("SELECT MAX(idUbicacion) FROM Ubicacion;");
                                    while (r.next()) {
                                        ultimo = r.getInt(1);
                                    ...
                                    String p="INSERT INTO Ubicacion (idUbicacion, Descripcion) VALUES (" + (ultimo + 1) + ",'"+nuevo+"');";
                                    con.insertarBD(p);
