...
public class MovimientoController implements Serializable {
    ...
    @EJB
    private Controller.MovimientoFacade ejbFacade;
    ...
    public static class MovimientoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Movimiento) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Movimiento.class.getName());
            }
        }
